...
export const translations = {
  zh: {
    ...
    templateSubjectDesc: '配置工作流模板的维度字段，必选维度不可禁用',
    fieldKey: '字段Key',
    displayName: '显示名称',
    dataSource: '数据源',
    required: '必填',
    ...
    no: '否',
    note: '说明：',
    templateSubjectNote1: '必选维度（客户、起运港区域、目的港区域、运输模式）不可禁用',
  ...
  en: {
    ...
    templateSubjectDesc: 'Configure dimension fields for workflow templates. Required dimensions cannot be disabled.',
    fieldKey: 'Field Key',
    ...
    no: 'No',
    note: 'Note:',
    templateSubjectNote1: 'Required dimensions (Customer, Origin Region, Destination Region, Transport Mode) cannot be disabled',
